...
public class RabbitMQConfig {
     ...
     * - "cars.created"  → попадёт в очередь с binding key "cars.*"
     * - "dealer.deleted" → попадёт в очередь с binding key "#" (все события)
     *
     ...
     * - q.audit.cars с "cars.*" — только события книг,
     * - q.notification.dealer с "dealer.created" — уведомления при создании автора.
     */
    @Bean
